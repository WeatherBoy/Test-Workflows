...
\\
\\
In \autoref{fig:python-system-overview} is an attempt at giving an (incomplete) overview of how the system works. The system is built entirely in Python, and the codebase can be seen in its entirety on GitHub \github{https://github.com/WeatherBoy/Test-Workflows}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.90\textwidth]{figures/methodology/python_system.png}
