...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/analysis/datamodel-diagram.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.70\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/analysis/exam-results-v1.png}
        \subcaption*{Examination results \texttt{DiagnosticReport} solution.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.25\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/analysis/exam-results-v2.png}
        \subcaption*{Examination results \texttt{List} of: \texttt{Observation} solution.}
    \end{subfigure}
